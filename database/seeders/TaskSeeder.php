...
class TaskSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($tasks as $data) {
            ...
            // Tambah submission demo untuk task berstatus review atau done
            if (in_array($task->status, ['review', 'done']) && $task->assignee_id) {
                $task->update([
                    'submission_note' => match ($task->status) {
                        'review' => 'Draft sudah selesai, mohon direview. File ada di Google Drive: https://drive.google.com/example',
                        'done' => 'Final sudah dikirimkan. Semua revisi telah diselesaikan.',
                        default => null,
                    },
